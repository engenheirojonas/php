...
//---------Mandar Dados do Usuário a partir do login para o painel index.php----------------

$id_usuario = @$_SESSION['id'];
$consult = $pdo->query("SELECT * from usuarios where id = '$id_usuario' ");
...
<head>
	...
	<!-- DataTables -->
	<link href="DataTables/DataTables-1.10.23/css/jquery.dataTables.min.css" rel="stylesheet" type="text/css">
	<link href="DataTables/DataTables-1.10.23/css/dataTables.bootstrap.min.css" rel="stylesheet" type="text/css">
	<script src="DataTables/DataTables-1.10.23/js/jquery.dataTables.min.js"></script>
	<script src="DataTables/DataTables-1.10.23/js/dataTables.bootstrap.min.js"></script>

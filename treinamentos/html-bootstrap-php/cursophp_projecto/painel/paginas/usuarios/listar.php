...
for ($i=0; $i < $linhas; $i++) {
	...
	$data = $res[$i]['Data'];
		...
		//para a data nao ser exibida no formato americano, mas sim no formato brasileiro
	$dataF = implode('/', array_reverse(explode('-', $data)));

		//se o usuario estiver ativo, ele vai mostrar o icone de check, caso contrario ele vai mostrar o icone de quadrado vazio
	if($ativo == 'Sim'){
...
<!--codigo para configurar datatable-->
